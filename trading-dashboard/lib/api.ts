  ...
  return [
    {
      ...
      evaluations: [
        { role: 'technical',    score: 78, confidence: 0.82 },
        { role: 'fundamental',  score: 71, confidence: 0.74 },
        { role: 'vision',       score: 68, confidence: 0.65 },
        { role: 'risk',         score: 80, confidence: 0.90 },
        { role: 'social',       score: 72, confidence: 0.60 },
      ],
    },
    {
      ...
      evaluations: [
        { role: 'technical',    score: 25, confidence: 0.78 },
        { role: 'fundamental',  score: 31, confidence: 0.70 },
        { role: 'vision',       score: 27, confidence: 0.62 },
        { role: 'risk',         score: 30, confidence: 0.88 },
        { role: 'social',       score: 28, confidence: 0.55 },
      ],
    },
    {
      ...
      regime: 'risk_on', sector: 'Technology', hot_sector: true, timestamp: new Date().toISOString(),
      evaluations: [
        { role: 'technical',    score: 72, confidence: 0.80 },
        { role: 'fundamental',  score: 66, confidence: 0.75 },
        { role: 'vision',       score: 65, confidence: 0.68 },
        { role: 'risk',         score: 75, confidence: 0.91 },
        { role: 'social',       score: 60, confidence: 0.58 },
      ],
    },
  ]
}
